...
import static cms.storage.JsonAdaptedPerson.MISSING_FIELD_MESSAGE_FORMAT;
...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_SOCUSERNAME = BENSON.getSocUsername().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_NUSID,
                        VALID_SOCUSERNAME, VALID_GITHUBUSERNAME, VALID_ADDRESS,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL,
                VALID_NUSID, VALID_SOCUSERNAME, VALID_GITHUBUSERNAME, VALID_ADDRESS,
                VALID_ROLE, VALID_TUTORIALGROUP, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_NUSID, VALID_SOCUSERNAME, VALID_GITHUBUSERNAME, INVALID_ADDRESS,
                VALID_ROLE, VALID_TUTORIALGROUP, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_NUSID, VALID_SOCUSERNAME, VALID_GITHUBUSERNAME, null,
                VALID_ROLE, VALID_TUTORIALGROUP, VALID_TAGS);
