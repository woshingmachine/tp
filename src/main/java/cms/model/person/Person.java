...
public class Person {
     ...
     */
    public Person(Name name, Phone phone, Email email, NusId nusId, SocUsername socUsername, GithubUsername githubUsername, Address address, Role role, TutorialGroup tutorialGroup, Set<Tag> tags) {
